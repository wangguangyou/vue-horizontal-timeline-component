...
git remote add github https://$GITHUB_TOKEN@github.com/wangguangyou/vue-horizontal-timeline-component.git > /dev/null 2>&1
git push github HEAD:master --follow-tags

GREN_GITHUB_TOKEN=$GITHUB_TOKEN yarn release

url=https://api.github.com/repos/wangguangyou/vue-horizontal-timeline-component/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "vue-horizontal-timeline-component更新", "text": "@所有人\n# [vue-horizontal-timeline-component('$version')]('$html_url')\n'$body'"}}'
